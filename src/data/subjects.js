export const PROGRAMS = [
  { id: "tp", name: "หลักสูตรไทย", icon: "🇹🇭" },
  { id: "ep", name: "English Program", icon: "🌍" },
];

export const SUBJECTS = [
  { id: "thai", program: "tp", name: "ภาษาไทย", color: "#FF6B81", color2: "#FF9AA8", dark: "#E14C63", icon: "📕", quizSeconds: 20 },
  { id: "math", program: "tp", name: "คณิตศาสตร์", color: "#4FC3F7", color2: "#7DD5FA", dark: "#2AA9E0", icon: "📘", quizSeconds: 120 },
  ...
  { id: "ep_science", program: "ep", name: "Science", color: "#7ED957", color2: "#A3E683", dark: "#57B335", icon: "🔬", quizSeconds: 20 },
];